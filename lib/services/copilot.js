...
module.exports = class CopilotService extends Schmervice.Service {
    ...
    async startSession(page, config) {
        ...
        // this.server.events.on(clickInspectEvt, async ({ x, y }) => {
        //
            // Don't know how to disable the mouse events, or how to
            // get an elementNode path array for any given x/y coordinates
        //     await page.mouse.click(x, y);
        // });
